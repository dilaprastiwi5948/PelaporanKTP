            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group @error('name') has-error @enderror"">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Nama {{$title}}" name="name" value="{{old('name') ?? $data->userdetail->name}}">
                        @error('name')
                    ...
                    <div class="form-group @error('nik') has-error @enderror"">
                        ...
                        <input type="number" class="form-control" id="nik" placeholder="NIK {{$title}}" name="nik" value="{{old('nik') ?? $data->userdetail->nik}}">
                        @error('nik')
                    ...
                    <div class="form-group @error('position') has-error @enderror"">
                        ...
                        <input type="text" class="form-control" id="position" placeholder="Jabatan {{$title}}" name="position" value="{{old('position') ?? $data->userdetail->position}}">
                        @error('position')
                ...
                <div class="col-sm-6">
                    <div class="form-group @error('username') has-error @enderror"">
                        ...
                        <input type="text" class="form-control" id="username" placeholder="Username {{$title}}" name="username" value="{{old('username') ?? $data->username}}">
                        @error('username')
                    ...
                    <div class="form-group @error('is_admin') has-error @enderror"">
                        ...
                        <select name="is_admin" class="form-control" id="is_admin">
                            <option {{(old('is_admin') ?? $data->is_admin) == 1 ? "required" : ""}} value="1">Operator</option>
                            <option {{(old('is_admin') ?? $data->is_admin) == 0 ? "required" : ""}} value="0">Admin</option>
                        </select>
                        @error('is_admin')
